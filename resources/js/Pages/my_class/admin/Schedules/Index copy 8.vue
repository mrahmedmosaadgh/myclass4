                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                    ...
                    <div class="table-wrapper">
                        <table class="w-full border-collapse">
                            <thead>
                                <tr>
                                    <th class="first-cell">Classroom</th>
                                    <th v-for="period in 8"
                                        ...
                                        P{{ period }} <!-- Shortened from "Period" to "P" -->
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
...
td, th {
    ...
    min-width: 120px; /* Reduced from default or previous value */
    max-width: 180px; /* Add max-width to prevent cells from getting too wide */
}

/* First column (classroom names) specific sizing */
.sticky-cell, .first-cell {
    @apply p-2;
    min-width: 140px; /* Adjust based on your content needs */
    max-width: 160px;
}

/* If you have content that might overflow */
td, th {
    white-space: nowrap;
    overflow: hidden;
...
/* For nested content (like grade info) */
.text-xs {
    @apply mt-0.5; /* Reduced margin */
}

/* Adjust any card content inside cells */
.h-full.p-2.rounded.border {
    @apply p-1.5; /* Reduced padding */
}
</style>
